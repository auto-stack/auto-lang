...
`,R=`row (style: "flex-wrap", gap: "4") {
    col (gap: "2", style: "w-[150px]") {
        ...
        text (style: "text-sm text-muted-foreground", text: "Square (1:1)") {}
    }
    col (gap: "2", style: "w-[150px]") {
        div (style: "bg-muted rounded-md overflow-hidden") {
            aspect-ratio (ratio: 1.777) {
