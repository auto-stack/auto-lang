...
`,R=`row (gap: "4", style: "flex-wrap") {
    ...
    col (gap: "2", style: "w-[150px]") {
        ...
        text (text: "Widescreen (16:9)", style: "text-sm text-muted-foreground") {}
    }
    col (gap: "2", style: "w-[150px]") {
        div (style: "bg-muted rounded-md overflow-hidden") {
    ...
    col (style: "w-[150px]", gap: "2") {
        ...
        text (style: "text-sm text-muted-foreground", text: "Standard (4:3)") {}
    }
}
