...
`,Te=`col (gap: "4") {
    ...
    row (style: "flex items-center justify-between") {
        ...
        row (gap: "2") {
            ...
            button (text: "Next", size: "sm", variant: "outline") {}
        }
    }
}
