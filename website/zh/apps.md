...
<div class="apps-list">
  <div class="app-section" id="autoshell">
    <div class="app-header">
      ...
      <div>
        <h2><a href="/zh/apps/autoshell/">AutoShell</a></h2>
  ...
  <div class="app-section" id="automusk">
    <div class="app-header">
      <div class="app-icon">🤖</div>
      <div>
        <h2><a href="/zh/apps/automusk/">AutoMusk</a></h2>
        <span class="app-status beta">Beta</span>
      </div>
    </div>
    <p class="app-desc">
  ...
  <div class="app-section" id="autodown">
    <div class="app-header">
      <div class="app-icon">📄</div>
      <div>
        <h2><a href="/zh/apps/autodown/">AutoDown</a></h2>
  ...
  <div class="app-section" id="autoui-demos">
    <div class="app-header">
      <div class="app-icon">🎨</div>
      <div>
        <h2><a href="/zh/apps/autoui/">AutoUI Demos</a></h2>
        <span class="app-status alpha">Alpha</span>
      </div>
    </div>
    <p class="app-desc">
