...
| 三、AutoUI 与 App 生成域 | 2 章 + 2 子目录 | 域级章 16/20；需求级设计归 `autoui/`（9）与 `blocks/`（4） |
...
对账公式：1(本索引) + 18(00–16、20 章号) + 1(25 在途) + 9(autoui 含 README) + 4(blocks)
+ 2(流程) + 4(strategy) + 3(诊断) + 5(forge) + 67(raw) = **113**。
