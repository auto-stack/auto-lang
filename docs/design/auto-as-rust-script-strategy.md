...
**日期**: 2026-07-17
**状态**: Accepted（母纲已确认；配套实施计划见 `docs/plans/357-auto-as-rust-script-rollout.md`）
**作者**: ZCode brainstorming session
**性质**: 高层策略纲领（high-level strategy framework）。本文档是 4 个子项目（A 门面 / B 旗舰 / C 地基 / D 弹药）的**母纲**。配套实施计划 `docs/plans/357-auto-as-rust-script-rollout.md` 将母纲拆解为可执行的阶段任务；后续每个子项目仍可各自出更细的 spec。
...
本纲领已确认。配套实施计划：**`docs/plans/357-auto-as-rust-script-rollout.md`**。
