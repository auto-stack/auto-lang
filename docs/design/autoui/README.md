...
| [component-time-and-events](component-time-and-events.md) | — | 嵌套组件时间源与交互契约：TimeSource 收集/挂载过滤订阅/多层 props·msg·store 路径；D-2 类型级退订；gallery 内嵌 Tick 缺口 | 652（阶段 1）；阶段 2 path 级另拆 |
