...
> ⚠️ **2026-07-14 迁移**：本文引用的 ASH 计划（281–330）已迁至独立仓库 `../auto-shell/plans/` 并重编号 012–026。
> 旧号 → 新号：281→012、291→013、295→014、297→015、301→016、302→017、303→018、304→019、309→020、315→021、317→022、318→023、320→024、322→025、330→026。
> 下文仍按历史旧号称呼同一批计划。
...
> 迁移计划见 Plan 023（原 318，已迁至 `../auto-shell/plans/`）。
