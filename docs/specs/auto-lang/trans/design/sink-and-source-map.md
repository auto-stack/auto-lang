...
> 来源: crates/auto-lang/src/trans.rs；docs/plans/archive/167-module-system.md、archive/168-shared-variable.md（MultiSink/escape_str 代码注释）、archive/219-playground-source-map.md
