...
| GOAL-009 | 虚拟桌面与桌面 Shell：跨平台虚拟桌面（Web+桌面双端）、WM、自动排布、Launcher | 进行中 | Design [23](../design/autoui/virtual-desktop.md)/[24](../design/autoui/desktop-shell-and-launcher.md)、plans 452/462–465 |
