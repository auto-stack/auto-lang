...
| GOAL-007 | AutoUI 跨端视觉一致：Vue 与 VM/iced 双端 base styles 与 parity 锁定 | 进行中 | Design [22](../design/autoui/base-styles-and-visual-parity.md)、plans 455/458/411/437（chart 组件双端同源，ADR-19）、504（静态分发函数双端同语义） |
