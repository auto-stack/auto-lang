...
| GOAL-005 | Python parity 第三维度：use.py 调 Python 库 + a2py 反向转译 | 部分达成 | [strategy/python-parity-roadmap](../design/strategy/python-parity-roadmap.md)、plan-369、539（PyTorch 训练/推理脚本级——六条 DIV-PY 债清偿+16 内建族 kwargs/May/迭代/matmul/getitem/with/float/callable+12 opcode dunder 路由+py_torch_infer 16/16 与 py_torch_train 10/10 三方套件+回调桥；py_subclass 延期 P539-D4） |
