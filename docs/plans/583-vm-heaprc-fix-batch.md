...
- [ ] **T8 api_gen vm 模式跳过 rust-server**
...
4. **579 联动**：sub 对齐后 auto-kanban lang_plans.at raw 公式改回
   (start,len) 形态——回 579 续行时第一件事，已登记于 579 待澄清 #1。
