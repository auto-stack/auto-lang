# ArkTS Backend Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Add ArkTS (HarmonyOS/Harmony Next) backend support for AutoUI, enabling AURA widgets to be transpiled into ArkTS code.
...
Add to `crates/auto-lang/src/ui_gen/ark/components.rs`:
