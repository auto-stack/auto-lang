...
| P026-D3 | low | 协议边界 | **native auto 缺省维持 independent（复测未达标）**——026 行 judged 76.2%；**029 复测 judged 72.7%**（样本 35→36 扩容稀释 + 046-tabs 入分母；009 opacity 放行翻绿、041 popover 半句清偿——缺项 hidden/定位族/样式 grid/tabs 全在册）；翻转点已备（resolve_native_frame_mode Covered 臂 one-line），随 ramp v3 复评；~~live iced 壳 IME 订阅缺口~~已随 P025-D1 核销（029 接线） | desktop-protocol-v1.md §1.8/§1.10；docs/plans/reports/p029-native-flip-retest-row.md |
