...
> (docs/design/autoui/virtual-desktop.md, ruling R2): on Windows/macOS the
...
(doc 20 §5-§6, §9) are deferred to **[Plan 386](386-autoui-renderqueue-future-optimization.md)**
as an independent future-optimization plan. COSMIC compatibility does not require
RenderQueue — Host ② (libcosmic, in-process) is sufficient. Plan 386's entry
...
| W5 | (Deferred) RenderCommand/RenderQueue/compositor per doc 20 | ➡️ Plan 386 | ⭐⭐⭐⭐⭐ | new crates | **Moved to [Plan 386](386-autoui-renderqueue-future-optimization.md)** — independent future-optimization plan; not needed for COSMIC compatibility (Host ② is in-process) |
...
| W5 | ➡️ Plan 386 | RenderQueue/compositor moved to independent future-optimization plan; not needed for COSMIC compatibility |
