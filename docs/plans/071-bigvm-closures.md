...
- Proper CAPTURE_VAR implementation (load variable from scope, not push 0)
- CALL_CLOSURE environment loading (restore closure.env to scope before execution)
...
### Priority 3: Escape Analysis (LOW PRIORITY - Optimization)
