...
> **2026-08-22 第二批归档**:402(038 扫雷,实机确认由 G3 闭环)/346(实施项清零:3c+三件套)/411(P0-P2 全数落地,两项决议登记债务簿)/243(Phase 5/6 由 Plan 416 补完)——详见 archive/ 各状态行与 KNOWN-DEBT-AND-RISKS.md 新四条。
