...
Browses the AutoUI **bp** catalog (`/bps/<kind>/<name>/`) as-authored:
...
it always reflects `bps/` on disk.
...
- **Sidebar**: bps grouped by kind (form / data-display / …).
- **Blueprint page**: the spec body (NL), a variant switcher, the reference `.at`
...
See [docs/design/bps/bps-first-class.md](../../docs/design/bps/bps-first-class.md)
and [Plan 342](../../docs/plans/342-bp-tier-phase-a-package-foundation.md).
