...
| 025 | dashboard | 系统监视器（KPI 卡 + 三实时面积曲线 + 可排序进程表 + 配置持久化；mock 随机游走，API 形状见 SPEC） | 4025 | ✅ [Plan 438](../../docs/plans/438-025-dashboard.md)（M1 vue 实机 6/6 + M1-fix 双生成器缺口根治 + M2 vm desktop_mcp 26/26） |
