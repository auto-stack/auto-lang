...
impl Component for App {
    ...
    fn state_snapshot(&self) -> std::collections::HashMap<String, auto_lang::ui::auto_val::Value> {
        ...
        m.insert("store.active_id".to_string(), auto_lang::ui::auto_val::Value::Int(self.store.active_id));
        m.insert("store.sort_mode".to_string(), auto_lang::ui::auto_val::Value::str(&self.store.sort_mode));
        m.insert("store.search".to_string(), auto_lang::ui::auto_val::Value::str(&self.store.search));
        m.insert("store.loading".to_string(), auto_lang::ui::auto_val::Value::Bool(self.store.loading));
        m.insert("store.dark_mode".to_string(), auto_lang::ui::auto_val::Value::Bool(self.store.dark_mode));
        m.insert("store.active_folder".to_string(), auto_lang::ui::auto_val::Value::str(&self.store.active_folder));
        m.insert("store.active_tag".to_string(), auto_lang::ui::auto_val::Value::str(&self.store.active_tag));
        m.insert("store.accent_color".to_string(), auto_lang::ui::auto_val::Value::str(&self.store.accent_color));
        m
    }
}
...
impl Component for NoteItem {
    ...
    fn state_snapshot(&self) -> std::collections::HashMap<String, auto_lang::ui::auto_val::Value> {
        let mut m = std::collections::HashMap::new();
        m.insert("is_active".to_string(), auto_lang::ui::auto_val::Value::Bool(self.is_active));
        m.insert("search".to_string(), auto_lang::ui::auto_val::Value::str(&self.search));
        m
    }
}
