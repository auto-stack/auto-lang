...
impl Atom {
    ...
    ///
    /// This method attempts to convert a Value into an Atom. Only Node, Array, and Obj
    ...
    /// # Returns
    ///
    /// Returns `Ok(Atom)` if the value is a Node, Array, or Obj, otherwise returns
...
impl AtomBuilder {
    ...
    pub fn array_values(self, values: impl IntoIterator<Item = impl Into<auto_val::Value>>) -> Self {
        let array = auto_val::Array::from(values);
        self.array(array)
    }
