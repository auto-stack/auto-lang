    ...
    fn add_feedback_elements(elements: &mut HashMap<&'static str, ElementDef>) {
        ...
        elements.insert("autodown", ElementDef {
            ...
            props: vec![
                ...
                PropDef { name: "table_col_widths", type_: PropType::StateRef, required: false, default: None, description: "Table column widths state: Map<tableKey str, List<px float>> keyed 't{blockHash}' (VM arm consumed since PLAN-045 — header-edge drag lands per-table key, persists across re-renders; vue arm ignores — no engine consumer)" },
                PropDef { name: "dark_mode", type_: PropType::Union(vec![PropType::Bool, PropType::StateRef]), required: false, default: Some("false"), description: "Theme declaration entry (PLAN-051): palette档 for the document face (vue arm darkMode → .is-dark; VM consumes the same-named STATE via the Plan 370 D-GAP global sync, prop itself inert on the VM arm)" },
                PropDef { name: "accent", type_: PropType::Union(vec![PropType::String, PropType::StateRef]), required: false, default: Some("indigo"), description: "Accent palette name (PLAN-051): indigo|coral|ocean|sage|amber (vue arm data-accent; VM document-accent consumption is a registered PARITY exemption)" },
                PropDef { name: "class", type_: PropType::Union(vec![PropType::String, PropType::StyleBinding]), required: false, default: None, description: "CSS class(es)" },
            ],
            allows_children: false,
        ...
        elements.insert("autodown_editor", ElementDef {
            ...
            props: vec![
                ...
                PropDef { name: "dark_mode", type_: PropType::Union(vec![PropType::Bool, PropType::StateRef]), required: false, default: Some("false"), description: "Theme declaration entry (PLAN-051): palette档 for the editor face (vue arm darkMode → .is-dark; VM consumes the same-named STATE via the Plan 370 D-GAP global sync, prop itself inert on the VM arm)" },
                PropDef { name: "accent", type_: PropType::Union(vec![PropType::String, PropType::StateRef]), required: false, default: Some("indigo"), description: "Accent palette name (PLAN-051): indigo|coral|ocean|sage|amber (vue arm data-accent; VM document-accent consumption is a registered PARITY exemption)" },
