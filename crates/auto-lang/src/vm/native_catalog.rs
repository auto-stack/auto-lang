...
macro_rules! for_each_native {
    ($mac:ident) => {
        $mac! {
            ...
            (4, NATIVE_ASSERT, shim_assert, "auto.assert"),
            ...
            (118, NATIVE_ITERATOR_ENUMERATE, shim_iterator_enumerate, "auto.iterator.enumerate"),

            // === HashMap (119-128, 1290-1292) ===
            (119, NATIVE_HASHMAP_NEW, shim_hashmap_new, "auto.hashmap.new"),
            (120, NATIVE_HASHMAP_INSERT_STR, shim_hashmap_insert_str, "auto.hashmap.insert_str"),
            (121, NATIVE_HASHMAP_INSERT_INT, shim_hashmap_insert_int, "auto.hashmap.insert_int"),
            (122, NATIVE_HASHMAP_GET_STR, shim_hashmap_get_str, "auto.hashmap.get_str"),
            (123, NATIVE_HASHMAP_GET_INT, shim_hashmap_get_int, "auto.hashmap.get_int"),
            (124, NATIVE_HASHMAP_CONTAINS, shim_hashmap_contains, "auto.hashmap.contains"),
            (125, NATIVE_HASHMAP_REMOVE, shim_hashmap_remove, "auto.hashmap.remove"),
            (126, NATIVE_HASHMAP_SIZE, shim_hashmap_size, "auto.hashmap.size"),
            (127, NATIVE_HASHMAP_CLEAR, shim_hashmap_clear, "auto.hashmap.clear"),
            (128, NATIVE_HASHMAP_DROP, shim_hashmap_drop, "auto.hashmap.drop"),
...
pub const NATIVE_ID_ENTRIES: &[(&str, u16)] = &[
    ...
    ("auto.iterator.enumerate", 118),
    ("auto.hashmap.new", 119),
    ("Map.new", 119),
    ("HashMap.new", 119),
    ("auto.hashmap.insert_str", 120),
    ("auto.hashmap.insert_int", 121),
    ("auto.hashmap.get_str", 122),
    ("auto.hashmap.get_int", 123),
    ("auto.hashmap.contains", 124),
    ("auto.hashmap.remove", 125),
    ("auto.hashmap.size", 126),
    ("auto.hashmap.clear", 127),
    ("auto.hashmap.drop", 128),
    ("auto.hashmap.insert", 120),
    ("auto.hashmap.get", 122),
