...
#[test] fn test_aavm_99_bootstrap_069_bvm_str_len() { test_aavm("99_bootstrap/069_bvm_str_len").unwrap(); }
#[test] fn test_aavm_99_bootstrap_070_bvm_str_methods() { test_aavm("99_bootstrap/070_bvm_str_methods").unwrap(); }
#[test] fn test_aavm_99_bootstrap_071_bvm_map_str() { test_aavm("99_bootstrap/071_bvm_map_str").unwrap(); }
#[test] fn test_aavm_99_bootstrap_072_bvm_list_set() { test_aavm("99_bootstrap/072_bvm_list_set").unwrap(); }
#[test] fn test_aavm_99_bootstrap_073_bvm_list_pop() { test_aavm("99_bootstrap/073_bvm_list_pop").unwrap(); }
#[test] fn test_aavm_99_bootstrap_074_bvm_str_ops() { test_aavm("99_bootstrap/074_bvm_str_ops").unwrap(); }
#[test] fn test_aavm_99_bootstrap_075_bvm_char_at_diag() { test_aavm("99_bootstrap/075_bvm_char_at_diag").unwrap(); }
#[test] fn test_aavm_99_bootstrap_076_bvm_str_len_diag() { test_aavm("99_bootstrap/076_bvm_str_len_diag").unwrap(); }
#[test] fn test_aavm_99_bootstrap_077_type_infer_diag() { test_aavm("99_bootstrap/077_type_infer_diag").unwrap(); }
#[test] fn test_aavm_99_bootstrap_078_suffix_diag() { test_aavm("99_bootstrap/078_suffix_diag").unwrap(); }
#[test] fn test_aavm_99_bootstrap_079_suffix_direct() { test_aavm("99_bootstrap/079_suffix_direct").unwrap(); }
#[test] fn test_aavm_99_bootstrap_080_suffix_loop() { test_aavm("99_bootstrap/080_suffix_loop").unwrap(); }
#[test] fn test_aavm_99_bootstrap_081_char_at_expr() { test_aavm("99_bootstrap/081_char_at_expr").unwrap(); }
#[test] fn test_aavm_99_bootstrap_082_char_at_loop() { test_aavm("99_bootstrap/082_char_at_loop").unwrap(); }
#[test] fn test_aavm_99_bootstrap_083_suffix_func() { test_aavm("99_bootstrap/083_suffix_func").unwrap(); }
#[test] fn test_aavm_99_bootstrap_084_nested_fn_char_at() { test_aavm("99_bootstrap/084_nested_fn_char_at").unwrap(); }
#[test] fn test_aavm_99_bootstrap_085_two_str_params() { test_aavm("99_bootstrap/085_two_str_params").unwrap(); }
#[test] fn test_aavm_99_bootstrap_086_two_params_char_at() { test_aavm("99_bootstrap/086_two_params_char_at").unwrap(); }
#[test] fn test_aavm_99_bootstrap_087_loop_two_params() { test_aavm("99_bootstrap/087_loop_two_params").unwrap(); }
