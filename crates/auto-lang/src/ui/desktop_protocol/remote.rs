...
let expect_styled: Vec<u8> = vec![
        ...
        // "https://example.com/a.png" + fit=Stretch（tag 6 线格式冻结）。
        let image_frame = ProtocolMsg::Frame(FrameMsg::FrameReady {
            wid: 1,
            frame_id: 2,
            slot: 0,
            damage: None,
        ...
        let expect_image: Vec<u8> = vec![
            0x41, 0x50, 0x44, 0x4c, 0x01, 0x00, 0x02, 0x00, 0x54, 0x00, 0x00, 0x00, 0x04, 0x01,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x09,
            0x0e, 0x1a, 0xff, 0x01, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x41, 0x00, 0x00,
            0x00, 0x41, 0x00, 0x00, 0xc8, 0x42, 0x00, 0x00, 0x20, 0x42, 0x19, 0x00, 0x00, 0x00,
            0x68, 0x74, 0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
            0x65, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x2e, 0x70, 0x6e, 0x67, 0x01,
        ];
