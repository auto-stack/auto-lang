...
impl ScrollIntent {
    ...
    pub fn resolve(&self, current: &ScrollState) -> ResolvedScrollIntent {
        ...
        ResolvedScrollIntent {
            axis,
            offset: geometry::clamp_offset(&state, resolved),
            source,
        }
    }
}
...
mod tests {
    ...
    fn resolve_scroll_by_clamps_at_edges() {
        ...
        let over = ScrollIntent::ScrollBy {
            axis: Axis::Y,
            delta: 10_000.0,
            source: ScrollSource::Wheel,
        }
        ...
        let under = ScrollIntent::ScrollBy {
            axis: Axis::Y,
            delta: -500.0,
            source: ScrollSource::Wheel,
        }
    ...
    fn resolve_page_by_uses_viewport_extent() {
        ...
        let half_back = ScrollIntent::PageBy {
            axis: Axis::Y,
            pages: -1.0,
            source: ScrollSource::Keyboard,
        }
        .resolve(&r_into(&r, 250.0, 2000.0));
    ...
    fn resolve_x_axis_independent_of_y() {
        ...
        cur.x = Some(ScrollAxisState {
            offset: 10.0,
            viewport_extent: 100.0,
            content_extent: 2_000_000.0,
        });
        let r = ScrollIntent::ScrollTo {
            axis: Axis::X,
            offset: 1_500_000.0,
            source: ScrollSource::Programmatic,
        }
    ...
    fn source_carried_through_resolve() {
        ...
        for intent in [
            ...
            ScrollIntent::PageBy {
                axis: Axis::Y,
                pages: 1.0,
                source: ScrollSource::NativeScrollbar,
            },
        ] {
