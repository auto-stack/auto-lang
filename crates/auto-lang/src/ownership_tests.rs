...
"#;
    ...
    fn test_borrow_checker_integration() {
        ...
        assert!(result3.is_err(), "Mut borrow should conflict with view borrows");
    ...
    fn test_borrow_different_targets() {
        ...
        assert!(result2.is_ok(), "Mut borrow of y should not conflict with x");
    }
    ...
    fn test_lifetime_region_overlap() {
        ...
        // Should not overlap
        assert!(!ctx.regions_overlap(lt1, lt2), "Non-overlapping regions should not overlap");
